...
class Paint:
    ...
    def menu_bar(self):
        ...
        menu_img = ["open.png", "save.png", "exit.png", "undo.png", "cut.png", "copy.png", "paste.png", "text.png",
                    "about.png", "new.png", "cursor.png", "gesture.png", "help.png", "font_family.png", "font_size.png", "bold.png", "italic.png", "underline.png", "strikeout.png"]
        for i in range(19):
            self.menu_img_container.append(i)
            self.menu_img_container[i] = ImageTk.PhotoImage(
                Image.open("Utils/Pictures/Menu_bar/" + menu_img[i]).resize((30, 30), Image.Resampling.LANCZOS))
        # FILE MENU
        ...
        text_menu.add_cascade(label="Font Family", menu=font_menu,  image=self.menu_img_container[13], compound=LEFT,
                              background="white", foreground="blue", font=("Arial", 10, "bold"),
                              activebackground="blue", activeforeground="white")

        #text_menu.add_command(label="Change Text", command=self.set_text)
        text_menu.add_command(label="Font Size", command=self.set_font_size,  image=self.menu_img_container[14], compound=LEFT,
                              background="white", foreground="blue", font=("Arial", 10, "bold"),
                              activebackground="blue", activeforeground="white")
        text_menu.add_command(label="Bold", command=self.set_font_weight,  image=self.menu_img_container[15], compound=LEFT,
                              background="white", foreground="blue", font=("Arial", 10, "bold"),
                              activebackground="blue", activeforeground="white")
        text_menu.add_command(label="Italic", command=self.set_font_slant,  image=self.menu_img_container[16], compound=LEFT,
                              background="white", foreground="blue", font=("Arial", 10, "bold"),
                              activebackground="blue", activeforeground="white")
        text_menu.add_command(label="Underline", command=self.set_font_underline,  image=self.menu_img_container[17], compound=LEFT,
                              background="white", foreground="blue", font=("Arial", 10, "bold"),
                              activebackground="blue", activeforeground="white")
        text_menu.add_command(label="Strike Out", command=self.set_font_overstrike,  image=self.menu_img_container[18], compound=LEFT,
                              background="white", foreground="blue", font=("Arial", 10, "bold"),
                              activebackground="blue", activeforeground="white")
    ...
    def __init__(self):
        ...
        self.zoom_in_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Tools/zoom in.png").resize((25, 20), Image.Resampling.LANCZOS))
        ...
        self.zoom_out_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Tools/zoom out.png").resize((25, 20), Image.Resampling.LANCZOS))
        ...
        self.eraser_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Tools/eraser.png").resize((28, 20), Image.Resampling.LANCZOS))
        ...
        self.pencil_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Tools/pencil.png.").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.line_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Tools/line.png").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.colorbox_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Tools/bucket.png").resize((25, 20), Image.Resampling.LANCZOS))
        ...
        self.rectangle_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Shapes/rectangle.png").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.circle_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Shapes/circle.png").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.triangle_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Shapes/triangle.png").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.pentagon_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Shapes/pentagon.png").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.hexagon_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Shapes/hexagon.png").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.parallelogram_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Shapes/parallelogram.png").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.selection_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Tools/selection_box.png").resize((24, 20), Image.Resampling.LANCZOS))
        ...
        self.screen_shot_img = ImageTk.PhotoImage(
            Image.open("Utils/Pictures/Tools/screen_shot.png").resize((24, 20), Image.Resampling.LANCZOS))
   ...
   # ZOOM USING BUTTONS
    ...
    def insert_txt(self, event):
        text_font = tk.font.Font(family=self.font_family, size=self.font_size,
                                weight=self.font_weight, slant=self.font_slant, underline=self.font_underline,
                                overstrike=self.font_overstrike)
        take = self.canvas.create_text(event.x, event.y, text=self.txt, font= text_font, fill = self.colour)
        
        #event.widget.create_text(self.x1_line_pt, self.y1_line_pt, fill=self.fill_color, font=text_font, text=self.text)
        self.stack.append(take)
        self.stack.append('$')
    ...
    def about():
        ...
        messagebox.showinfo("ABOUT", "A paint applications where you can draw with varying brush size,"
                            ...
                            " Cursor mode or Gesture mode using hand movements. Developed by Lokeswar P"
